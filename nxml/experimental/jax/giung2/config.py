...
_C.DATASETS.DOWNSAMPLED_IMAGENET = ConfigDict()
...
# VGGNet
_C.MODEL.BACKBONE.VGGNET = ConfigDict()
...
# LeNet
_C.MODEL.BACKBONE.LENET = ConfigDict()
...
# VisionTransformer
_C.MODEL.BACKBONE.VIT = ConfigDict()
_C.MODEL.BACKBONE.VIT.PATCH_SIZE = 16
_C.MODEL.BACKBONE.VIT.HIDDEN_SIZE = 768
_C.MODEL.BACKBONE.VIT.TRANSFORMER = ConfigDict()
...
# Batch Normalization
# ---------------------------------------------------------------------- #
_C.MODEL.BATCH_NORMALIZATION = ConfigDict()
...
# Layer Normalization
# ---------------------------------------------------------------------- #
_C.MODEL.LAYER_NORMALIZATION = ConfigDict()
_C.MODEL.LAYER_NORMALIZATION.EPSILON = 1e-5

# ---------------------------------------------------------------------- #
# Group Normalization
# ---------------------------------------------------------------------- #
_C.MODEL.GROUP_NORMALIZATION = ConfigDict()
...
# ---------------------------------------------------------------------- #
_C.MODEL.FILTER_RESPONSE_NORMALIZATION = ConfigDict()
...
_C.MODEL.BATCH_ENSEMBLE.INITIALIZER = ConfigDict()
