...
from torch_xla.distributed import xla_backend as xb
...
def launch(
    ...
    if num_local_devices == "auto" or num_local_devices == -1:
        ...
        num_local_devices = len(xm.get_xla_supported_devices(devkind="TPU"))
...
def _mp_launcher(
    ...
    # available_local_devices = len(xm.get_xla_supported_devices(devkind="TPU"))
