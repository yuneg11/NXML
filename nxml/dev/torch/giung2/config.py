...
_C.MODEL.META_ARCHITECTURE = ConfigDict()
...
# BatchEnsemble
# ---------------------------------------------------------------------- #
_C.MODEL.BATCH_ENSEMBLE = ConfigDict()
...
# SpatialDropout
# ---------------------------------------------------------------------- #
_C.MODEL.SPATIAL_DROPOUT = ConfigDict()
...
# DropBlock
# ---------------------------------------------------------------------- #
_C.MODEL.DROP_BLOCK = ConfigDict()
...
_C.DATASETS.IMAGENET = ConfigDict()
...
# Backbone
# ---------------------------------------------------------------------- #
_C.MODEL.BACKBONE = ConfigDict()
_C.MODEL.BACKBONE.NAME = "build_resnet_backbone"

# ResNet options
_C.MODEL.BACKBONE.RESNET = ConfigDict()
_C.MODEL.BACKBONE.RESNET.CHANNELS = 3
_C.MODEL.BACKBONE.RESNET.IN_PLANES = 64
_C.MODEL.BACKBONE.RESNET.FIRST_BLOCK = ConfigDict()
...
# Classifier
# ---------------------------------------------------------------------- #
_C.MODEL.CLASSIFIER = ConfigDict()
_C.MODEL.CLASSIFIER.NAME = "build_softmax_classifier"

# SoftmaxClassifier options
_C.MODEL.CLASSIFIER.SOFTMAX_CLASSIFIER = ConfigDict()
...
_C.MODEL.CLASSIFIER.DUQ_CLASSIFIER = ConfigDict()
...
_C.MODEL.CLASSIFIER.CENTROID_CLASSIFIER = ConfigDict()
...
_C.SOLVER.OPTIMIZER.SGHMC = ConfigDict()
...
_C.SOLVER.SCHEDULER.WARMUP_SIMPLE_COSINE_LR = ConfigDict()
...
_C.SOLVER.SCHEDULER.WARMUP_CYCLICAL_COSINE_LR = ConfigDict()
...
_C.SOLVER.SCHEDULER.WARMUP_MULTI_STEP_LR = ConfigDict()
...
_C.SOLVER.SCHEDULER.WARMUP_LINEAR_DECAY_LR = ConfigDict()
